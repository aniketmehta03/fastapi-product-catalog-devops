...
helm.sh/chart: {{ include "product-api.chart" . }}
...
*/}}
{{- define "product-api.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "product-api.fullname" .) .Values.serviceAccount.name }}
{{- else }}
